...
-- Add keys for table Jazdy_probne

ALTER TABLE "Jazdy_probne" ADD CONSTRAINT "Unique_Identifier14" PRIMARY KEY ("ID_Uslugi")
/
...
ALTER TABLE "Ubezpieczenia" ADD CONSTRAINT "Unique_Identifier17" PRIMARY KEY ("ID_Uslugi")
/
...
-- Add keys for table Sprzedaze_samochodow

ALTER TABLE "Sprzedaze_samochodow" ADD CONSTRAINT "Unique_Identifier20" PRIMARY KEY ("ID_Uslugi")
/
...
ALTER TABLE "Modele" ADD CONSTRAINT "Należa Do" FOREIGN KEY ("ID_marki_modelu") REFERENCES "Marki_modeli" ("ID_marki_modelu")
/
...
ALTER TABLE "Salony_Samochodowe" ADD CONSTRAINT "Adres salonu" FOREIGN KEY ("ID_adresu") REFERENCES "Adresy" ("ID_adresu")
/
...
ALTER TABLE "Leasingi" ADD CONSTRAINT "Uslugi Leasing" FOREIGN KEY ("ID_Uslugi") REFERENCES "Uslugi" ("ID_Uslugi")
/
